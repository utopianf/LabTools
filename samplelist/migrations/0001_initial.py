# Generated by Django 2.1.7 on 2019-04-23 00:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fab_date', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chem_formula', models.CharField(max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('comment', models.TextField(blank=True, null=True)),
                ('furnace', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='samplelist.Furnace')),
            ],
        ),
        migrations.CreateModel(
            name='FurnaceStep',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('temperature', models.FloatField()),
                ('data_file', models.FileField(upload_to=samplelist.models.mh_file_name)),
                ('comment', models.TextField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_file', models.FileField(upload_to=samplelist.models.mt_file_name)),
                ('comment', models.TextField(blank=True, null=True)),
                ('raw_file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='samplelist.MPMSRawFile')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, null=True)),
                ('chemical_substance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='samplelist.ChemicalSubstance')),
            ],
            options={
                'ordering': ['chemical_substance'],
            },
        ),
        migrations.CreateModel(
            name='Target',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('syn_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('comment', models.TextField(blank=True, null=True)),
                ('chemical_substance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='targets', to='samplelist.ChemicalSubstance')),
                ('furnace_sequence', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='targets', to='samplelist.FurnaceSequence')),
            ],
        ),
        migrations.AddField(
            model_name='sample',
